...
def main(*args) -> None:
    ...
    match query_number:
        ...
        case "5":
            ...
            user_input = input("Введите ключевые слова для поиска через пробел (ключевое слово по умолчанию "
                               "- 'разработчик программист')").lower()
...
if __name__ == "__main__":
    # Если передать любой аргумент, то программа пропустит пользовательский запрос и примет значения по умолчанию
    main(1)
